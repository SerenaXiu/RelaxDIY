...
<body id="generalBackground" style="position:relative">
  ...
  <p>Calligraphy is the flower of a man′ s soul.</p>
    ...
    <img src="Img/_coursepics/elisabeth11.jpeg" class="zoom" style="width:400px; height:400px; margin-left:40px; border-radius:50%; padding:0px;">
	</br>
  ...
  <img src="Img/_coursepics/aboutcalli1.jpg" class="zoom" style="width:400px; height:400px; margin-left:40px; border-radius:50%; padding:0px;">
 ...
 <div style="position:absolute;">
    ...
    <img src="Img/_coursepics/callipic.jpg" class="zoom" style="width:400px; height:400px; margin-left:40px; border-radius:50%; padding:0px;">
	</br>
