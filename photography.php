...
<body id="generalBackground">
  ...
  <h1 style="margin-top:70px">Photography with Serena</h1>
  <p>In photography there is a reality so subtle that it becomes more real than reality.</p>
    ...
    <img src="Img/Coursespics/serena.jpeg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
  ...
  <img src="Img/Coursespics/aboutphoto1.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
	
  </div>
  
 <div class="column side">
    <img src="Img/Coursespics/photopic11.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
