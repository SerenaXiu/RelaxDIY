...
<!---------------------------------------------------------------------------------------------------------->
			...
			<div id="judyta" class="person float">
			<h2>Judyta Krzyzak</h2>
			<div>
				<table class="tables float"><tr>
					<td><span id="placeholderImg">
...
<!---------------------------------------------------------------------------------------------------------->
			...
			<div id="thomas" class="person float">
			<h2>Thomas Kellner</h2>
			<div>
				<table class="tables float"><tr>
					<td><span id="placeholderImg">
...
<!---------------------------------------------------------------------------------------------------------->
		...
		<div id="elisabethM" class="personM">
		<h2>Elisabeth Kohlhofer</h2>
		<div>
			<table class="tables float"><tr>
				<td><span id="placeholderImg">
		...
		<span><p class="text"> 
			...
			for big business to give them a special touch. Elisabeth hopes to fuel your 
			enthusiasm for the art of hand-lettering as well. Her lessons are easy to 
			follow and there's no need for special equipment! Just give it a try.
		<p/></span>
...
<!---------------------------------------------------------------------------------------------------------->
		...
		<span><p class="text"> 
			...
			As a trained Zumba instructor her aim is to stop your brain from worrying by 
			getting your hips moving. Never mind if your endurance is "yea" or rather 
			"nay" &ndash; there's the right course for everyone.
		<p/></span>
