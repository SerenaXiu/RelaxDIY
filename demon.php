...
<body>
  ...
  <img src="Img/_coursepics/aboutdemons111.jpg" class="zoom" style="width:400px; height:400px; margin-left:40px; border-radius:50%; padding:0px;">
 ...
 <div style="position:absolute;">
    ...
    <img src="Img/_coursepics/demonpic.jpg" class="zoom" style="width:400px; height:400px; margin-left:40px; border-radius:50%; padding:0px;">
	</br>
