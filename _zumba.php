...
<body id="generalBackground">
  ...
  <p>Let Zumba Fitness be your stress reliever!</p>
    ...
    <img src="Img/Coursespics/judyta1.jpeg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
  ...
  <img src="Img/Coursespics/111.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
	
  </div>
  
 <div class="column side">
    <img src="Img/Coursespics/zumbapic.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
