...
<body id="generalBackground">
  ...
  <p>Laughter is brightest where food is best</p>
    ...
    <img src="Img/_coursepics/gaelle1.jpeg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
  ...
  <img src="Img/_coursepics/aboutcook12.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
	
  </div>
  
 <div class="column side">
    <img src="Img/_coursepics/cookingpic.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
