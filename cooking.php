...
<body id="generalBackground">
  ...
  <p>Laughter is brightest where food is best</p>
    ...
    <img src="Img/Coursespics/gaelle1.jpeg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
  ...
  <img src="Img/Coursespics/aboutcook12.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
	
  </div>
  
 <div class="column side">
    <img src="Img/Coursespics/cookingpic.jpg" style="width:400px; height:400px; margin-left:40px; border-radius:50%">
